...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('profile.mua.portfolio.store') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="col-md-3 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" action="{{ route('profile.mua.portfolio.delete', $portfolio->id) }}" class="mt-2" onsubmit="return confirm('Yakin ingin menghapus?')">
                                @csrf
                                @method('DELETE')
