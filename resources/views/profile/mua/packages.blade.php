...
<div class="row mb-4">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('profile.mua.packages.store') }}">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                ...
                                <form method="POST" action="{{ route('profile.mua.packages.delete', $package->id) }}" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="modal fade" id="editModal{{ $package->id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('profile.mua.packages.update', $package->id) }}">
                                @csrf
                                @method('PUT')
